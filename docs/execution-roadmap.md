...
| Fase 2: Resiliencia y observabilidad | En curso | `/health`, `/metrics`, `/diagnostics`, alertas operativas, request ids, counters, timings, logs estructurados, buffer de problemas recientes y logs secundarios unificados en simulador/fallback | Trazas distribuidas |
